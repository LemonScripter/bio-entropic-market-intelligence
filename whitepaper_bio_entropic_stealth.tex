...
\pagestyle{fancy}
\fancyhf{}
\rhead{\textcolor{darkgray}{Bio-Entropikus Stealth Keretrendszer}}
\lhead{\textcolor{darkgray}{Műszaki Fehér Könyv \& Ellenpróba}}
\rfoot{\thepage}

\title{\textbf{\LARGE Bio-Entropikus Webes Adatgyűjtő Keretrendszer}\\[0.3em]
...
\textbf{Kockázat:} Ha a böngésző magas szinten Chrome User-Agent-et mutat, de az alacsony szintű TLS Handshake (Cipher Suite-ok sorrendje, ALPN, TLS kiterjesztések) ettől eltér, az Akamai és Cloudflare rendszerek \textit{Passive OS / TLS Fingerprinting} alapján azonnal szűrik a kapcsolatot.\\
\textbf{Megoldás:} A Chromium natív hálózati veremének használata vagy uTLS/curl\_cffi bridge integrálása a közvetlen HTTP hívásokhoz.
\end{tcolorbox}
